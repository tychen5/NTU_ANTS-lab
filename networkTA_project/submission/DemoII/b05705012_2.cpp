...
int main() {
	...
	addr.sin_addr.s_addr = inet_addr("127.0.0.1"); // 設定 IP	Server IP: 140.112.107.194 port=33120							   // addr.sin_addr.s_addr = INADDR_ANY; // 若設定 INADDR_ANY 表示任何 IP
	addr.sin_family = AF_INET;
	addr.sin_port = htons(12345); // 設定 port 33120
